...
/* package brick-example-0.1.0.0 */
#ifndef VERSION_brick_example
#define VERSION_brick_example "0.1.0.0"
#endif /* VERSION_brick_example */
#ifndef MIN_VERSION_brick_example
#define MIN_VERSION_brick_example(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_brick_example */
...
#define CURRENT_COMPONENT_ID "brick-example-0.1.0.0-9evgD2tGFr9EfT0xvVe5K5-brick-example"
